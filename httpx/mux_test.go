...
func TestRouterAPI(t *testing.T) {
	...
	router := NewMux()
	router.GET("/GET", func(w http.ResponseWriter, r *http.Request) { get = true })
	router.HEAD("/GET", func(w http.ResponseWriter, r *http.Request) { head = true })
	router.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request) { options = true })
	router.POST("/POST", func(w http.ResponseWriter, r *http.Request) { post = true })
	router.PUT("/PUT", func(w http.ResponseWriter, r *http.Request) { put = true })
	router.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request) { patch = true })
	router.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request) { delete = true })
