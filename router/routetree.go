...
type routeTrees []routeTree

func (trees routeTrees) get(method string) *node {
...
func (n *node) getValue(path string, paramsIn Params) (handlers HandlersChain, params Params) {
	params = paramsIn
